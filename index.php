...
<div class="hidden"><?php include('assets/itsolution24/img/iconmin/membership/membership.svg');?></div>
  ...
  <section class="login-box">
      ...
      <form id="login-form" action="login.php" method="post">       
        ...
        <div class="form-group">
          <div class="input-group">
            ...
            <input type="text" class="form-control" value="prueba@siriuz.com.mx" placeholder="Email / Phone No." name="username">
          </div>
        </div>
    ...
    <div class="copyright text-center">
      <p>&copy; <a href="https://www.siriuz.com.mx">Siriuz Software</a></p>
    </div>
  </section>
